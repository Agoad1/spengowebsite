...
import { ArrowLeft, Phone, PhoneForwarded, UserCog, Volume2 } from 'lucide-react';
import Link from 'next/link';

export default function PhoneServicePage() {
    const features = [
        { title: 'AI Voice Interaction', desc: 'Capable of natural, human-like conversations to qualify and book leads.', icon: <Volume2 className="w-5 h-5" /> },
        { title: 'Instant Call-Backs', desc: 'Trigger an automated call-back seconds after a lead submits their info.', icon: <PhoneForwarded className="w-5 h-5" /> },
        { title: 'Agent Integration', desc: 'Seamlessly transfer high-intent callers directly to your sales team.', icon: <UserCog className="w-5 h-5" /> },
    ];
            ...
            <main className="pt-32 pb-24">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <header className="mb-20">
                        ...
                        >
                            Phone Caller <span className="text-primary italic">Automation</span>
                        </motion.h1>
                        <p className="text-muted text-xl leading-relaxed max-w-2xl">
                            Scale your sales team with AI. Our phone automation systems can qualify leads, answer questions, and even schedule appointments over the phone, all without human intervention.
                        </p>
                    </header>
                    ...
                    <div className="bg-primary/10 rounded-3xl p-12 border border-primary/20 text-center">
                        <h2 className="font-outfit font-bold text-white text-3xl mb-6">Ready for AI voice transformation?</h2>
                        <p className="text-muted mb-10 max-w-lg mx-auto">
                            Get a free audit to see how AI phone calls can revolutionize your sales funnel.
                        </p>

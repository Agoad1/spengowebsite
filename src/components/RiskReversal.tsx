    ...
    return (
        <section className="py-24 bg-surface relative overflow-hidden">
            <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                ...
                >
                    We don't do meaningless monthly retainers or hidden fees. We provide a clear, professional audit for free. If you don't believe our plan will transform your site's performance, you walk away with the audit and pay zero. If we do work together and you aren't wowed by the results, we'll give you every cent back. <span className="text-white font-semibold">The risk is entirely on us.</span>
                </motion.p>
            </div>
